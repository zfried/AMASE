...
def compute_molecule_lookup_table(mol, label, log_columns, tempInput, dv_value, cont, ll0, ul0, data, vlsr_value = 0.0):
    ...
    src = molsim.classes.Source(size=1.E20, dV=dv_value, velocity=vlsr_value, Tex=tempInput, column=log_columns[0], continuum = cont)
